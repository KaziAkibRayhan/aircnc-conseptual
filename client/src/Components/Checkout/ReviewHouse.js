...
const ReviewHouse = ({ setSelectedIndex, homeData }) => {
  // const from = format(new Date(homeData?.from), "ccc")
  // console.log(from);
  // const from = format(new Date(homeData?.from), "PP")
  //   .split(",")[0]
  //   .split(" ")[0];
  // console.log(from);
  return (
    <>
      ...
      <div className="flex flex-wrap gap-10 mt-4">
        <div className="flex justify-between gap-2">
          ...
          <div>
            <p>{format(new Date(homeData?.from), "ccc")} check-in</p>
            <p>After 12:00 PM</p>
          </div>
        </div>
        <div className="flex justify-between">
          <div className="flex justify-between gap-2">
            ...
            <div>
              <p>{format(new Date(homeData?.to), "ccc")} check-in</p>
              <p>After 12:00 PM</p>
            </div>
          </div>
        </div>
